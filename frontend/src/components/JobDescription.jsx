        ...
        <div className='max-w-7xl mx-auto my-10'>
            ...
            {singleJob?.company && (
                <div className='my-6 p-4 border border-gray-200 rounded-lg'>
                    <h2 className='font-bold text-lg mb-3'>Company Information</h2>
                    <div className='flex items-center gap-4 mb-3'>
                        {singleJob?.company?.logo && (
                            <img src={singleJob?.company?.logo} alt={singleJob?.company?.name} className="w-16 h-16 rounded-full object-cover" />
                        )}
                        <div>
                    ...
                    {singleJob?.company?.description && (
                        <p className='text-gray-700 mb-2'>{singleJob?.company?.description}</p>
                    )}
                    {singleJob?.company?.website && (
                        <a href={singleJob?.company?.website} target="_blank" rel="noopener noreferrer" className='text-blue-600 hover:underline text-sm'>
                            Visit Website
                        </a>
                    )}
                </div>
